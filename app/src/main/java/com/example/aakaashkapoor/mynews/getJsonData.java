...
public class getJsonData extends AsyncTask<String,Void,Void> {
    ...
    protected Void doInBackground(String... voids) {
        try {
            ...
            httpURLConnection.addRequestProperty("X-AYLIEN-NewsAPI-Application-ID","02c8a372" );
            httpURLConnection.addRequestProperty("X-AYLIEN-NewsAPI-Application-Key", "be2db86e18a3d783014a7826e61e1e48");
